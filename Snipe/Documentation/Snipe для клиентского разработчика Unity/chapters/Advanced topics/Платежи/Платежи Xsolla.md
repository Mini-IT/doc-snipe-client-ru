...
6) После успешного платежа сервер Xsolla запустит вебхук и уведомит Снайп о платеже. Снайп отправит сообщение клиенту: `type=payment/generic.completed, params={ id:string, itemID:string, results:[]PaymentResult, provider=xsol, orderID:string }`
